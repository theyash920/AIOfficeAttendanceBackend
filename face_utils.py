...
def get_face_embedding(image_bytes):
    ...
    try:
        ...
        embedding_objs = DeepFace.represent(
            img_path=img,
            model_name="ArcFace",
            detector_backend="retinaface",  # Lightweight detector for low memory environments
...
def compare_faces(known_embedding, new_embedding, threshold=0.35):
    """
    Compare two ArcFace embeddings using Cosine Similarity.
    DeepFace default threshold for ArcFace is usually around 0.40.
